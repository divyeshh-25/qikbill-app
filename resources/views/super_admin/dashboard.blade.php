<x-layout.app title="Dashboard - Super Admin">
    <div class="content">
            ...
            <ul class="table-top-head">
                ...
                <li>
                    <a data-bs-toggle="tooltip" data-bs-placement="top" id="collapse-header" aria-label="Collapse"
                        data-bs-original-title="Collapse" class=""><i data-feather="chevron-up"
        ...
        <div class="welcome-wrap mb-4">
            ...
            <div class="welcome-bg">
                <img src="{{ asset('assets/img/bg/welcome-bg-02.svg') }}" alt="img" class="welcome-bg-01">
                ...
                <div class="card flex-fill">
                    ...
                    <div class="card-body">
                        ...
                        <p class="f-13 d-inline-flex align-items-center"><span
                                class="badge badge-success me-1">+6%</span> 5
                ...
                <div class="card flex-fill">
                    ...
                    <div class="card-body pb-2">
                        <div class="d-sm-flex justify-content-between flex-wrap mb-3">
                            <div class="d-flex align-items-center mb-2">
                                <a href="javscript:void(0);" class="avatar bg-gray-100 rounded-circle flex-shrink-0">
                                    <img src="{{ asset('assets/img/company/company-02.svg') }}"
                                ...
                                <div class="ms-2 flex-fill">
                                    ...
                                    <p class="fs-13 d-inline-flex align-items-center"><span
                                            ...
                                            class="ti ti-circle-filled fs-6 text-primary mx-1"></i>14 Jan 2025
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="d-sm-flex justify-content-between flex-wrap mb-3">
                            <div class="d-flex align-items-center mb-2">
                                <a href="javscript:void(0);" class="avatar bg-gray-100 rounded-circle flex-shrink-0">
                                    <img src="{{ asset('assets/img/company/company-03.svg') }}"
                                        class="img-fluid w-auto h-auto" alt="img">
                                </a>
                                <div class="ms-2 flex-fill">
                        ...
                        <div class="d-sm-flex justify-content-between flex-wrap mb-3">
                            <div class="d-flex align-items-center mb-2">
                                <a href="javscript:void(0);" class="avatar bg-gray-100 rounded-circle flex-shrink-0">
                                    <img src="{{ asset('assets/img/company/company-05.svg') }}"
                                        class="img-fluid w-auto h-auto" alt="img">
                                </a>
                                <div class="ms-2 flex-fill">
                        ...
                        <div class="d-sm-flex justify-content-between flex-wrap mb-3">
                            <div class="d-flex align-items-center mb-2">
                                <a href="javscript:void(0);" class="avatar bg-gray-100 rounded-circle flex-shrink-0">
                                    <img src="{{ asset('assets/img/company/company-07.svg') }}"
                                        class="img-fluid w-auto h-auto" alt="img">
                                </a>
                                <div class="ms-2 flex-fill">
                        ...
                        <div class="d-sm-flex justify-content-between flex-wrap mb-1">
                            <div class="d-flex align-items-center mb-2">
                                <a href="javscript:void(0);" class="avatar bg-gray-100 rounded-circle flex-shrink-0">
                                    <img src="{{ asset('assets/img/company/company-08.svg') }}"
                                        class="img-fluid w-auto h-auto" alt="img">
                                </a>
                                <div class="ms-2 flex-fill">
                        ...
                        <div>
                            <div class="d-sm-flex align-items-center justify-content-between flex-wrap mb-3">
                                <div class="d-flex align-items-center mb-2">
                                    <a href="javscript:void(0);"
                                        class="avatar bg-gray-100 rounded-circle flex-shrink-0">
                                ...
                                <div class="d-flex align-items-center mb-2">
                                    ...
                                    <div class="ms-2 flex-fill">
                                        <h6 class="fs-medium text-truncate mb-1"><a
                                                href="javscript:void(0);">Hubspot</a>
                                        </h6>
                            ...
                            <div class="d-sm-flex align-items-center justify-content-between flex-wrap mb-3">
                                <div class="d-flex align-items-center mb-2">
                                    <a href="javscript:void(0);"
                                        class="avatar bg-gray-100 rounded-circle flex-shrink-0">
                                        <img src="{{ asset('assets/img/icons/company-icon-18.svg') }}"
                                            class="img-fluid w-auto h-auto" alt="img">
                                    </a>
                                    <div class="ms-2 flex-fill">
                            ...
                            <div class="d-sm-flex align-items-center justify-content-between flex-wrap mb-3">
                                <div class="d-flex align-items-center mb-2">
                                    ...
                                    <div class="ms-2 flex-fill">
                                        <h6 class="fs-medium text-truncate mb-1"><a
                                                href="javscript:void(0);">TerraFusion
                                                Energy</a></h6>
