                                        ...
                                        <div class="row row-cols-xxl-5 g-3">
                                            <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3 col-xxl">
                                                <div class="product-info card">
                                                    <a href="javascript:void(0);" class="product-image">
                                                        <img src="{{ asset('assets/img/products/pos-product-01.jpg') }}"
                                                            alt="Products">
                                                    </a>
                                                    <div class="product-content">
                                                        <h6 class="fs-14 fw-bold mb-1"><a
                                                                href="javascript:void(0);">Charger Cable</a></h6>
                                            ...
                                            <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3 col-xxl">
                                                <div class="product-info card active">
                                                    <a href="javascript:void(0);" class="product-image">
                                                        <img src="{{ asset('assets/img/products/pos-product-02.jpg') }}"
                                                            alt="Products">
                                                    </a>
                                                    <div class="product-content">
                                                        <h6 class="fs-14 fw-bold mb-1"><a
                                                                href="javascript:void(0);">Apple Airpods 2</a></h6>
                                                        <div class="d-flex align-items-center justify-content-between">
                                            ...
                                            <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3 col-xxl">
                                                <div class="product-info card">
                                                    <a href="javascript:void(0);" class="product-image">
                                                        <img src="{{ asset('assets/img/products/pos-product-03.jpg') }}"
                                                            alt="Products">
                                                    </a>
                                                    <div class="product-content">
                                                        <h6 class="fs-14 fw-bold mb-1"><a
                                                                href="javascript:void(0);">Vacuum Cleaner</a></h6>
                                                        <div class="d-flex align-items-center justify-content-between">
                                            ...
                                            <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3 col-xxl">
                                                <div class="product-info card">
                                                    <a href="javascript:void(0);" class="product-image">
                                                        <img src="{{ asset('assets/img/products/pos-product-04.jpg') }}"
                                                            alt="Products">
                                                    </a>
                                                    <div class="product-content">
                                                        <h6 class="fs-14 fw-bold mb-1"><a
                                                                href="javascript:void(0);">Realme 8 Pro</a></h6>
                                                        <div class="d-flex align-items-center justify-content-between">
                                            ...
                                            <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3 col-xxl">
                                                <div class="product-info card">
                                                    <a href="javascript:void(0);" class="product-image">
                                                        <img src="{{ asset('assets/img/products/pos-product-05.jpg') }}"
                                                            alt="Products">
                                                    </a>
                                                    <div class="product-content">
                                                        <h6 class="fs-14 fw-bold mb-1"><a
                                                                href="javascript:void(0);">Vacuum Robot</a></h6>
                                                        <div class="d-flex align-items-center justify-content-between">
                                            ...
                                            <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3 col-xxl">
                                                <div class="product-info card">
                                                    <a href="javascript:void(0);" class="product-image">
                                                        <img src="{{ asset('assets/img/products/pos-product-06.jpg') }}"
                                                            alt="Products">
                                                    </a>
                                                    <div class="product-content">
                                                        <h6 class="fs-14 fw-bold mb-1"><a
                                                                href="javascript:void(0);">Apple Watch Series 9</a></h6>
                                                        <div class="d-flex align-items-center justify-content-between">
                                            ...
                                            <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3 col-xxl">
                                                <div class="product-info card">
                                                    <a href="javascript:void(0);" class="product-image">
                                                        <img src="{{ asset('assets/img/products/pos-product-07.jpg') }}"
                                                            alt="Products">
                                                    </a>
                                                    <div class="product-content">
                                                        <h6 class="fs-14 fw-bold mb-1"><a
                                            ...
                                            <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3 col-xxl">
                                                <div class="product-info card">
                                                    <a href="javascript:void(0);" class="product-image">
                                                        <img src="{{ asset('assets/img/products/pos-product-08.jpg') }}"
                                                            alt="Products">
                                                    </a>
                                                    <div class="product-content">
                                                        <h6 class="fs-14 fw-bold mb-1"><a
                                                                href="javascript:void(0);">Bracelet</a></h6>
                                                        <div class="d-flex align-items-center justify-content-between">
                                            ...
                                            <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3 col-xxl">
                                                <div class="product-info card">
                                                    <a href="javascript:void(0);" class="product-image">
                                                        <img src="{{ asset('assets/img/products/pos-product-09.jpg') }}"
                                                            alt="Products">
                                                    </a>
                                                    <div class="product-content">
                                                        <h6 class="fs-14 fw-bold mb-1"><a
                                                                href="javascript:void(0);">YETI Flask</a></h6>
                                                        <div class="d-flex align-items-center justify-content-between">
                                            ...
                                            <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3 col-xxl">
                                                <div class="product-info card">
                                                    <a href="javascript:void(0);" class="product-image">
                                                        <img src="{{ asset('assets/img/products/pos-product-10.jpg') }}"
                                                            alt="Products">
                                                    </a>
                                                    <div class="product-content">
                                                        <h6 class="fs-14 fw-bold mb-1"><a
                                                                href="javascript:void(0);">Osmo Med Kit</a></h6>
                                                        <div class="d-flex align-items-center justify-content-between">
                                            ...
                                            <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3 col-xxl">
                                                <div class="product-info card">
                                                    <a href="javascript:void(0);" class="product-image">
                                                        <img src="{{ asset('assets/img/products/pos-product-11.jpg') }}"
                                                            alt="Products">
                                                    </a>
                                                    <div class="product-content">
                                                        <h6 class="fs-14 fw-bold mb-1"><a
                                                                href="javascript:void(0);">Celestique Perfume</a></h6>
                                                        <div class="d-flex align-items-center justify-content-between">
                                            ...
                                            <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3 col-xxl">
                                                <div class="product-info card">
                                                    <a href="javascript:void(0);" class="product-image">
                                                        <img src="{{ asset('assets/img/products/pos-product-12.jpg') }}"
                                                            alt="Products">
                                                    </a>
                                                    <div class="product-content">
                                                        <h6 class="fs-14 fw-bold mb-1"><a
                                                                href="javascript:void(0);">Dell XPS 13</a></h6>
                                                        <div class="d-flex align-items-center justify-content-between">
                                            ...
                                            <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3 col-xxl">
                                                <div class="product-info card">
                                                    <a href="javascript:void(0);" class="product-image">
                                                        <img src="{{ asset('assets/img/products/pos-product-13.jpg') }}"
                                                            alt="Products">
                                                    </a>
                                                    <div class="product-content">
                                                        <h6 class="fs-14 fw-bold mb-1"><a
                                                                href="javascript:void(0);">Cheese Snack</a></h6>
                                                        <div class="d-flex align-items-center justify-content-between">
                                            ...
                                            <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3 col-xxl">
                                                <div class="product-info card">
                                                    <a href="javascript:void(0);" class="product-image">
                                                        <img src="{{ asset('assets/img/products/pos-product-14.jpg') }}"
                                                            alt="Products">
                                                    </a>
                                                    <div class="product-content">
                                                        <h6 class="fs-14 fw-bold mb-1"><a
                                                                href="javascript:void(0);">Blue Boot Shoes</a></h6>
                                                        <div class="d-flex align-items-center justify-content-between">
                                            ...
                                            <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3 col-xxl">
                                                <div class="product-info card">
                                                    <a href="javascript:void(0);" class="product-image">
                                                        <img src="{{ asset('assets/img/products/pos-product-15.jpg') }}"
                                                            alt="Products">
                                                    </a>
                                                    <div class="product-content">
                                                        <h6 class="fs-14 fw-bold mb-1"><a
                                                                href="javascript:void(0);">Sonic Aura X7</a></h6>
                                                        <div class="d-flex align-items-center justify-content-between">
                                            ...
                                            <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3 col-xxl">
                                                <div class="product-info card">
                                                    <a href="javascript:void(0);" class="product-image">
                                                        <img src="{{ asset('assets/img/products/pos-product-16.jpg') }}"
                                                            alt="Products">
                                                    </a>
                                                    <div class="product-content">
                                                        <h6 class="fs-14 fw-bold mb-1"><a
                                                                href="javascript:void(0);">Brown Formal Shoes</a></h6>
                                                        <div class="d-flex align-items-center justify-content-between">
                                            ...
                                            <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3 col-xxl">
                                                <div class="product-info card">
                                                    <a href="javascript:void(0);" class="product-image">
                                                        <img src="{{ asset('assets/img/products/pos-product-17.jpg') }}"
                                                            alt="Products">
                                                    </a>
                                                    <div class="product-content">
                                                        <h6 class="fs-14 fw-bold mb-1"><a
                                                                href="javascript:void(0);">Apple Iphone 13 </a></h6>
                                                        <div class="d-flex align-items-center justify-content-between">
                                            ...
                                            <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3 col-xxl">
                                                <div class="product-info card">
                                                    <a href="javascript:void(0);" class="product-image">
                                                        <img src="{{ asset('assets/img/products/pos-product-18.jpg') }}"
                                                            alt="Products">
                                                    </a>
                                                    <div class="product-content">
                                                        <h6 class="fs-14 fw-bold mb-1"><a
                                                                href="javascript:void(0);">PixelCrafter 3000</a></h6>
                                                        <div class="d-flex align-items-center justify-content-between">
                                            ...
                                            <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3 col-xxl">
                                                <div class="product-info card">
                                                    <a href="javascript:void(0);" class="product-image">
                                                        <img src="{{ asset('assets/img/products/pos-product-19.jpg') }}"
                                                            alt="Products">
                                                    </a>
                                                    <div class="product-content">
                                                        <h6 class="fs-14 fw-bold mb-1"><a
                                                                href="javascript:void(0);">Citrify Orange Juice</a></h6>
                                                        <div class="d-flex align-items-center justify-content-between">
                                            ...
                                            <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3 col-xxl">
                                                <div class="product-info card">
                                                    <a href="javascript:void(0);" class="product-image">
                                                        <img src="{{ asset('assets/img/products/pos-product-20.jpg') }}"
                                                            alt="Products">
                                                    </a>
                                                    <div class="product-content">
                                                        <h6 class="fs-14 fw-bold mb-1"><a
                                                                href="javascript:void(0);">Aroma Coffee Maker</a></h6>
                                                        <div class="d-flex align-items-center justify-content-between">
                        ...
                        <aside class="product-order-list">
                            <div class="customer-info">
                                <div class="d-flex align-items-center justify-content-between flex-wrap gap-2 mb-2">
                                    ...
                                    <a href="#" class="btn btn-sm btn-outline-primary shadow-primary"
                                        data-bs-toggle="modal" data-bs-target="#create">Add Customer</a>
                                </div>
                                <select class="select">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center mb-1">
                                                                <h6 class="fs-16 fw-medium"><a href="#"
                                                                        data-bs-toggle="modal"
                                                                        data-bs-target="#products">Iphone 11S</a></h6>
                                                                <a href="#" class="ms-2 edit-icon"
                                                                    data-bs-toggle="modal"
                                                                    data-bs-target="#edit-product"><i
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center mb-1">
                                                                <h6 class="fs-16 fw-medium"><a href="#"
                                                                        data-bs-toggle="modal"
                                                                        data-bs-target="#products">Samsung Galaxy
                                                                        S21</a></h6>
                                                                <a href="#" class="ms-2 edit-icon"
                                                                    data-bs-toggle="modal"
                                                                    data-bs-target="#edit-product"><i
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center mb-1">
                                                                <h6 class="fs-16 fw-medium"><a href="#"
                                                                        data-bs-toggle="modal"
                                                                        data-bs-target="#products">Red Boot Shoes</a>
                                                                </h6>
                                                                <a href="#" class="ms-2 edit-icon"
                                                                    data-bs-toggle="modal"
                                                                    data-bs-target="#edit-product"><i
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center mb-1">
                                                                <h6 class="fs-16 fw-medium"><a href="#"
                                                                        data-bs-toggle="modal"
                                                                        data-bs-target="#products">Bracelet</a></h6>
                                                                <a href="#" class="ms-2 edit-icon"
                                                                    data-bs-toggle="modal"
                                                                    data-bs-target="#edit-product"><i
                                                                        class="ti ti-edit"></i></a>
                                    ...
                                    <div class="col-sm-4">
                                        <a href="javascript:void(0);"
                                            ...
                                            data-bs-toggle="modal" data-bs-target="#order-tax"><i
                                                class="ti ti-receipt-tax me-2"></i>Tax</a>
                                        <a href="javascript:void(0);"
            ...
            <div class="modal-content">
                <div class="modal-body">
                    <div class="icon-head text-center">
                        <a href="javascript:void(0);">
                            <img src="{{ asset('assets/img/logo.png') }}" width="100" height="30" alt="Receipt Logo">
                        </a>
                    </div>
                    <div class="text-center info text-center">
                        ...
                        <p class="mb-0">Email: <a
                                href="/cdn-cgi/l/email-protection#a9ccd1c8c4d9c5cce9cec4c8c0c587cac6c4"><span
                                    class="__cf_email__"
                                    data-cfemail="2f4a574e425f434a6f48424e4643014c4042">[email&#160;protected]</span></a>
                        </p>
                    </div>
                        ...
                        <div class="calculator-body d-flex justify-content-between">
                            ...
                            <div class="text-center">
                                ...
                                <button class="btn btn-number"
                                    ...
                                    data-cf-modified-fd1fbc84750239c4572e93b8-="">8</button>
                                <button class="btn btn-number"
                                    onclick="if (!window.__cfRLUnblockHandlers) return false; dis('5')"
                                    data-cf-modified-fd1fbc84750239c4572e93b8-="">5</button>
                                <button class="btn btn-number"
                                    onclick="if (!window.__cfRLUnblockHandlers) return false; dis('2')"
                                    data-cf-modified-fd1fbc84750239c4572e93b8-="">2</button>
                                <button class="btn btn-number"
                                    onclick="if (!window.__cfRLUnblockHandlers) return false; dis('00')"
                                    data-cf-modified-fd1fbc84750239c4572e93b8-="">00</button>
                            </div>
                            <div class="text-center">
                                <button class="btn btn-expression"
                                    onclick="if (!window.__cfRLUnblockHandlers) return false; dis('%')"
                                ...
                                <button class="btn btn-number"
                                    ...
                                    data-cf-modified-fd1fbc84750239c4572e93b8-="">9</button>
                                <button class="btn btn-number"
                                    onclick="if (!window.__cfRLUnblockHandlers) return false; dis('6')"
                                    data-cf-modified-fd1fbc84750239c4572e93b8-="">6</button>
                                <button class="btn btn-number"
                                    onclick="if (!window.__cfRLUnblockHandlers) return false; dis('3')"
                                    data-cf-modified-fd1fbc84750239c4572e93b8-="">3</button>
                                <button class="btn btn-number"
                                    onclick="if (!window.__cfRLUnblockHandlers) return false; dis('.')"
                                    data-cf-modified-fd1fbc84750239c4572e93b8-="">.</button>
                            </div>
                            <div class="text-center">
                                <button class="btn btn-clear"
                                    ...
                                    data-cf-modified-fd1fbc84750239c4572e93b8-=""><i
                                        class="ti ti-backspace"></i></button>
                                <button class="btn btn-expression"
                                    onclick="if (!window.__cfRLUnblockHandlers) return false; dis('*')"
                                    data-cf-modified-fd1fbc84750239c4572e93b8-="">x</button>
                                <button class="btn btn-expression"
                                    onclick="if (!window.__cfRLUnblockHandlers) return false; dis('-')"
                                    data-cf-modified-fd1fbc84750239c4572e93b8-="">-</button>
                                <button class="btn btn-expression"
