                                ...
                                <tbody>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <a href="product-list.html" class="avatar avatar-lg me-3">
                                                    <img src="{{ asset('assets/img/products/stock-img-01.png') }}" alt="img">
                                                </a>
                                                <div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <a href="product-list.html" class="avatar avatar-lg me-3">
                                                    <img src="{{ asset('assets/img/products/stock-img-06.png') }}" alt="img">
                                                </a>
                                                <div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <a href="product-list.html" class="avatar avatar-lg me-3">
                                                    <img src="{{ asset('assets/img/products/stock-img-02.png') }}" alt="img">
                                                </a>
                                                <div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <a href="product-list.html" class="avatar avatar-lg me-3">
                                                    <img src="{{ asset('assets/img/products/stock-img-03.png') }}" alt="img">
                                                </a>
                                                <div>
                        ...
                        <tbody>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <a href="javascript:void(0);" class="avatar avatar-lg me-2">
                                            <img src="{{ asset('assets/img/products/expire-product-01.png') }}" alt="img">
                                        </a>
                                        <div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <a href="javascript:void(0);" class="avatar avatar-lg me-2">
                                            <img src="{{ asset('assets/img/products/expire-product-02.png') }}" alt="img">
                                        </a>
                                        <div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <a href="javascript:void(0);" class="avatar avatar-lg me-2">
                                            <img src="{{ asset('assets/img/products/expire-product-03.png') }}" alt="img">
                                        </a>
                                        <div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <a href="javascript:void(0);" class="avatar avatar-lg me-2">
                                            <img src="{{ asset('assets/img/products/expire-product-04.png') }}" alt="img">
                                        </a>
                                        <div>
