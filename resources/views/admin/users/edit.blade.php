    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="name" id="name" placeholder="Kishanbhai Patel" value="{{ $user->name }}">
        ...
        <div class="col-lg-12">
            <div class="mb-3">
                ...
                <input type="email" class="form-control" name="email" id="email" placeholder="kishanpatel@gmail.com" value="{{ $user->email }}">
        ...
        <div class="col-lg-12">
            <div class="mb-3">
                ...
                <input type="tel" class="form-control" name="phone" id="phone" placeholder="78696543210" value="{{ $user->phone }}">
        ...
        <div class="col-lg-12">
            <div class="status-toggle modal-status d-flex justify-content-between align-items-center">
                ...
                <input type="checkbox" id="status" class="check" {{ $user->getRawOriginal('status') ? 'checked' : '' }} name="status">
